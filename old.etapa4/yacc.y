...
program: global { astreePrintTree($1,0) } //09/05:  impressao da arvore
	;

global:  /* lista de declaracoes globais */
	/* empty list */
	| global dec /* rec a esq, dec globais  */
	;
...
blococomandos:
	'{' comandosseq '}' { $$ = $2; astreePrintTree($2,0); }
	;
...
literal : 
 ...
 litseq : //sequencia de literais
	literal {$$ = (tree*)0;} //sequencia de literais nao pode ser vazia por causa da clausula vetordec  (que adiciona ':').
...
/* var declaration*/
 ...
 vardec:
	 tipos TK_IDENTIFIER ':' literal ';' { 

			if(DEBUG) fprintf(stdout,"Var %s inicializada\n",(char*)$2); 
				
				//vardec na arvore.
				//declaracao de var eh um nodo com 3 filhos, contendo o tipo,o indenficador e o literal
				// obs , o literal($4), ja esta declarado, restam o no filho de id($2) e de tipo($1).
...
*/
 ...
 expressao: literal {
	...
	|  TK_IDENTIFIER { 
				$$atreeCreate(ASTREE_SYMBOL,0,0,0,0,$1); //scanner necessita retornar ptr para tab de simbolos (ok)
			 } 
